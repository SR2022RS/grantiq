...
const I = {
  ...
  budget:   <svg fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 1.5v21M16.5 5.5H9.75a3.25 3.25 0 000 6.5h4.5a3.25 3.25 0 010 6.5H7"/></svg>,
