...
const GRANTS = [
  ...
  { id: "g7",  name: "Georgia DPH Community Health Workforce Grant", funder: "Georgia Dept. of Public Health",
    org_id: "holigenix_healthcare", amount: "$120,000", deadline: "2026-06-20", match_score: 78, status: "new",
    docs_ready: 11, docs_total: 18, source: "GA DPH bulletin",
    description: "Funds to expand pediatric home health workforce in underserved Georgia counties. Holigenix's GAPP approval and 100% EVV compliance via HHAeXchange are direct evidence of capacity.",
    eligibility: ["GA service area", "GAPP-approved", "EVV compliance"],
    advantage: "GAPP + EVV compliance is rare — preferred scoring." },
  { id: "g8",  name: "United Way of Greater Atlanta — Capacity Building", funder: "United Way of Greater Atlanta",
    org_id: "owner_nonprofit", amount: "$25,000", deadline: "2026-07-08", match_score: 72, status: "new",
    docs_ready: 4, docs_total: 11, source: "UWGA portal",
    description: "Operating support for Atlanta-area 501(c)(3) nonprofits.",
    eligibility: ["Metro Atlanta 501(c)(3)"],
    advantage: "Owner Nonprofit's GA roots align with UWGA service area." },
  ...
  { id: "g12", name: "Georgia Council on Developmental Disabilities Capacity Grant", funder: "GCDD (Georgia Council on Developmental Disabilities)",
    org_id: "owner_nonprofit", amount: "$60,000", deadline: "2026-07-22", match_score: 64, status: "new",
    docs_ready: 5, docs_total: 14, source: "GCDD bulletin",
    description: "Capacity-building grants for Georgia nonprofits serving people with developmental disabilities or their families.",
    eligibility: ["GA 501(c)(3)", "Programs serving people with disabilities"],
    advantage: "Aligns with GA-based mission and disability-services framing." },
];
...
const VAULT = [
  // Holigenix
  { id: "v1",  org_id: "holigenix_healthcare", required_for: "all",     doc_name: "Articles of Incorporation / Operating Agreement",            description: "Georgia LLC formation filing", status: "uploaded", uploaded_at: "2026-01-12" },
  ...
  { id: "v5",  org_id: "holigenix_healthcare", required_for: "all",     doc_name: "CV — Yinessa Davis-Cacapit, RN, BSN",  description: "Director of Nursing — credentials & experience",          status: "missing" },
  ...
  { id: "v10", org_id: "holigenix_healthcare", required_for: "state",   doc_name: "Georgia DCH Home Health License",      description: "Georgia DCH active license",                 status: "uploaded", uploaded_at: "2026-01-22", expires: "2027-01-22" },
  { id: "v11", org_id: "holigenix_healthcare", required_for: "state",   doc_name: "Georgia GAPP Provider Agreement",      description: "Georgia DCH GAPP Medicaid contract",         status: "uploaded", uploaded_at: "2026-02-12" },
...
const SOURCES = [
  ...
  { id: "src5",  name: "PA DCED weekly",           type: "State portal",     coverage: "PA economic development",     last_run: "2026-05-03T09:00:00Z", health: "ok",       items_24h: 6,   kept: 1,  org_relevance: ["k1_management"], cron: "0 9 * * 1" },
  { id: "src6",  name: "DE OSD bulletin",          type: "State portal",     coverage: "Delaware supplier diversity", last_run: "2026-05-04T07:05:00Z", health: "ok",       items_24h: 1,   kept: 1,  org_relevance: ["k1_management"], cron: "0 7 * * *" },
  { id: "src7",  name: "GA DCH / DPH bulletin",    type: "State portal",     coverage: "Georgia healthcare + public health",      last_run: "2026-05-04T07:05:00Z", health: "ok",       items_24h: 2,   kept: 1,  org_relevance: ["holigenix_healthcare"], cron: "0 7 * * *" },
  ...
  { id: "src12", name: "United Way of Greater Atlanta", type: "Foundation",   coverage: "UWGA funding opportunities",  last_run: "2026-05-02T07:00:00Z", health: "stale",    items_24h: 0,   kept: 0,  org_relevance: ["owner_nonprofit","holigenix_healthcare"], cron: "0 7 * * 5" },
...
const SUBMISSIONS = [
  ...
  { id: "sub5", grant_name: "United Way of Greater Atlanta Capacity",   funder_id: "f8", org_id: "owner_nonprofit",     amount_requested: "$20,000",  amount_awarded: "$15,000",  status: "awarded",      submitted: "2026-01-09", decided: "2026-03-22", confirmation: "UWGA-2026-077",     agent_hours: 3.4, agent_cost: "$22" },
  ...
  { id: "sub8", grant_name: "Community Foundation Greater Atlanta (FY24)",    funder_id: "f5", org_id: "owner_nonprofit",     amount_requested: "$50,000",  amount_awarded: "$0", status: "declined",     submitted: "2025-08-04", decided: "2025-11-08", confirmation: "—",                  agent_hours: 4.0, agent_cost: "$26", reviewer_notes: "Project scope too broad — narrow to 1 service area." },
...
const TEMPLATES = [
  { id: "t1", name: "Holigenix Mission Statement (3-sentence)",   org_id: "holigenix_healthcare", category: "mission",        word_count: 64,  uses: 9, last_used: "2026-05-04", body: "Holigenix Healthcare delivers compassionate, EVV-compliant pediatric home health services to medically complex children and their families across Cobb County and metro Atlanta, Georgia. As a Georgia GAPP-approved provider, we achieve 100% EVV compliance through HHAeXchange — a documented differentiator in Medicaid quality scoring. We expand dignified, in-home care for Georgia's underserved Medicaid-eligible pediatric population." },
  ...
  { id: "t3", name: "Holigenix Service Area Definition (Georgia)",   org_id: "holigenix_healthcare", category: "service-area",   word_count: 480, uses: 6,  last_used: "2026-05-04", body: "Holigenix's primary service area covers Cobb County, Georgia, with planned expansion across the Atlanta Metropolitan Area and statewide Georgia Medicaid waiver coverage…" },
